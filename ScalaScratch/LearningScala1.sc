object LearningScala1 {
  ...
  var helloThere: String = hello                  //> helloThere  : String = Xin Chao!
  helloThere = hello + " There!"
  println(helloThere)                             //> Xin Chao! There!
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = Xin Chao!There!
  println(immutableHelloThere)                    //> Xin Chao!There!
  val moreHello = immutableHelloThere + "yeah"    //> moreHello  : String = Xin Chao!There!yeah
  ...
  val double_pi = pi*2                            //> double_pi  : Double = 6.2831853
  println(f"Result: $double_pi%.3f")              //> Result: 6.283
