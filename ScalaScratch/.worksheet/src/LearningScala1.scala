object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(130); 
  // VALUES are immutable constants. You can't change them once defined.
  val hello: String = "Xin Chao!";System.out.println("""hello  : String = """ + $show(hello ));$skip(17); 
  ...
  val moreHello = immutableHelloThere + "yeah";System.out.println("""moreHello  : String = """ + $show(moreHello ));$skip(51); 
  ...
  val isBest: Boolean = picard == bestCaptain;System.out.println("""isBest  : Boolean = """ + $show(isBest ));$skip(194); 
  
  // EXERCISE
  // Write some code that takes the value of pi, doubles it, and then prints it within a string with
  // three decimal places of precision to the right.
  val double_pi = pi*2;System.out.println("""double_pi  : Double = """ + $show(double_pi ));$skip(37); 
  println(f"Result: $double_pi%.3f")}
